#LabelDistill/labeldistill/exps/nuscenes/labeldistill/LidarDistill_swinb_640x1600_e24_4keyfp.py
from labeldistill.exps.base_cli import run_cli
from labeldistill.exps.nuscenes.base_exp_swinb import \
...
class LabelDistillModel(BaseLabelDistillModel):
    ...
    def __init__(self, **kwargs):
        ...
        print("=" * 80)
        print("[INIT] LabelDistillModel.__init__ called with Swin-B backbone")
        print("=" * 80)
        ...
        fp_filter_cfg = {
            'FP_DISTANCE_THRESH': 4.0,
            'HIGH_SCORE_THRESH': 0.15
        }
        ...
        self.fp_distill_start_epoch = 1
        self.fp_distill_warmup_epochs = 2
        self.fp_distill_max_weight = 0.2
    ...
    def training_step(self, batch):  
        ...
        response_loss = 0.5 * response_loss
...
if __name__ == '__main__':
    run_cli(LabelDistillModel,
            'LidarDistill_swinb_640x1600_e24_4keyfp',
